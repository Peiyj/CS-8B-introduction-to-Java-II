...
public class GameTileFactory {
    ...
    public GameTile getTile(int value) {
        switch (rand.nextInt(NUM_CUSTOM_TILES)) {
            ...
            case 0: return new GameTileyjpei(value);
            case 1: return new GameTilea8yee(value);
            case 2: return new GameTileahaseeb(value);
            //case 1: return new GameTileahaseeb(value);
