 ...
 *
 *  CSE8B assignment 3.
 *  This file has class Transaction. Transaction.java is a java file 
 *  has 7 fields to transaction object. Specifically
 *  they are transactionNumber(string), cardNumber(string), 
 *  date (Date),vendor(String),purchaseAmount(double),
 *  isValid(boolean), invalidReason(String).

 * Name:    Transaction.java
 * Purpose: To store transaction info
 */
