 ...
 *
 *  CSE8B assignment 5.
 *  This file has class GameTile. GameTile is a java file 
 *  that uses hashmap to store an integer value with color.
 *  Specifically, the integer is the value of the tile and 
 *  the color is the color of the tile.
 */

/**
 * Name:    GameTile.java
 * Purpose: To store information about the GameTile class
 */
